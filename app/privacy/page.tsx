    ...
    <main id="main-content" className="policy-page">
      ...
      <div className="policy-layout">
        ...
        <article>
          ...
          <p>
            The newsletter form remains in preview mode unless a configured subscriber webhook is present. In preview mode the address you type is validated
            and then discarded; it is not written to any store. When a provider is connected, the email address and the signup source (for example
            “homepage” or “footer”) will be sent to that provider. A production policy must name the provider, purpose, retention, and deletion process
            before launch.
          </p>
          <p>
